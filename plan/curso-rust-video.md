...
- [ ] Explicar dónde inicia y termina la responsabilidad de FFmpeg.
- [ ] Diseñar un adaptador que pueda simularse sin FFmpeg instalado.
- [ ] Documentar la dependencia externa y sus riesgos de plataforma.
...
- [ ] Expresar un presupuesto por etapa y latencia de extremo a extremo.
- [ ] Medir el modelo local y documentar qué no representa.
- [ ] Comparar throughput, latencia y calidad de salida.
